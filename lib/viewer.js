...
function createVolumeRenderer(gl, array) {
  ...
  var zsplit = factorZ(array.shape[2]+2, array.shape[1]+2, array.shape[0])
  var gridW = bits.nextPow2((array.shape[2]+2) * zsplit[0])
  var gridH = bits.nextPow2((array.shape[1]+2) * zsplit[1])
